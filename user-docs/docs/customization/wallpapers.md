...
1. Open the **Wallpaper Panel**
2. Click **Set Global** and select an image or video file
3. The wallpaper appears behind all your chats

### Per-Chat Wallpaper

A wallpaper specific to one conversation:

1. Open the **Wallpaper Panel** while in a chat
